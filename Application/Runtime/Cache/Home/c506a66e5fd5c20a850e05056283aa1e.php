...
<section id="container" >
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="../HomePage/index.html" class="logo"><b>DASHGUM FREE</b></a>
        <!--logo end-->
        ...
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a  href="/index.php/Home/Admin/userManager">用 户</a></li>
                        <li><a  href="/index.php/Home/Admin/adminManager">管 理 员</a></li>
                    </ul>
                </li>
                <!--user end-->
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a  href="/index.php/Home/Admin/allEmails">全 部 邮 件</a></li>
                        <li><a  href="/index.php/Home/Admin/unReadEmails">未 读 邮 件</a></li>
                        <li><a  href="/index.php/Home/Admin/readEmails">已 读 邮 件</a></li>
                    </ul>
                </li>
                <!--email end-->
